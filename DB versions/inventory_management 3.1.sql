...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-11-2023 a las 22:49:37
...
INSERT INTO `equipments` (`id`, `name`, `created_at`, `updated_at`, `office`, `serial`, `mark`, `model`, `equipment_type`, `user`, `ram`, `ram_type`, `hard_disk`, `hard_type`, `proccesor`, `bought_at`, `deliver_at`, `init_value`, `final_value`, `sub_value`, `system`, `antivirus`, `phone`, `description`, `status`) VALUES
(1, 'PC-152', '2023-11-24 21:32:21', '2023-11-24 19:54:39', 'Technology', '5bacdecf003c0faf', 206, 'Pellentesque.mov', 261, 31, '8 GB', 376, '1 TB', 226, ' Intel Core i6', '2022-12-12', '2023-11-11', 5000, 4500, '0.1', 'Windows 10', 'Norton AntiVirus', NULL, 'Enhanced asynchronous contingency', 1),
(2, 'PC HP', '2023-11-24 21:33:21', '2023-11-24 21:33:21', 'IT', '12123121', 206, 'HP 450', 260, 10, '8 GB', 520, '250 GB', 225, 'Intel ', '2023-03-09', '2023-10-19', 100000, 80000, '0.2', 'Windows 10', 'ESET', NULL, 'computador para soporte IT', 1),
(3, 'PC HP02', '2023-11-24 21:37:31', '2023-11-24 21:37:31', 'IT', '12123121', 206, 'HP 450', 260, 10, '8 GB', 520, '250 GB', 225, 'Intel ', '2023-03-09', '2023-10-19', 100000, 80000, '0.2', 'Windows 10', 'ESET', NULL, 'computador para soporte IT', 1);
...
(1, 'Nuevo evento', 'un nuevo evento', 200, '1700853936757-Capacitacion.txt', 235, '31', 280, 240, 1, 75, '2023-11-14 05:00:00', NULL);
