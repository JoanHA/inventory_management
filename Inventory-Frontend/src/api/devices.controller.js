...
export const downloadHistoric = async (id) =>
  axios.get(URI + `api/equip/historical/${id}`);
//Obtener todos los colaboradores
export const getAllWorkers = async () => axios.get(URI + `api/workers/`);
//Actulizar equipo
export const update = async (id, datos) =>
  axios.put(URI + `api/equip/${id}`, datos);
//crear equipo
export const createEquip = async (values) =>
  axios.post(URI + "api/equip", values).then((res) => {
    try {
...
//guardar archivos
export const saveFiles = async (id, files) =>
  axios.post(URI + `api/equip/addFiles/${id}`, files);
...
export const deleteFiles = async (id) =>
  axios.delete(URI + `api/equip/files/${id}`);

//Obtener todos los moviles
export const getAllMobiles = async () =>
  axios.get(URI + `api/equip/cellphones/all`);

//Obtener todos los archivos de todos los equipos
export const bringAllFiles = async () =>
  axios.get(URI + `api/equip/bringFiles`);

//Crear pdf
export const editPDF = async (data) =>
  axios.post(URI + "api/utils/editPDF", data);
